...
export function FlashcardEditor({ initialData, onSave, onCancel }: CardEditorProps) {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    onSave({ prompt: prompt.trim(), answer: answer.trim(), explanation: explanation.trim() || undefined });
  }

  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      <div className="flex flex-col gap-1.5">
        <Label htmlFor="fc-prompt">Front (Prompt)</Label>
        <Textarea
          id="fc-prompt"
          value={prompt}
      ...
      <div className="flex flex-col gap-1.5">
        <Label htmlFor="fc-answer">Back (Answer)</Label>
        <Textarea
          id="fc-answer"
          value={answer}
      ...
      <div className="flex flex-col gap-1.5">
        <Label htmlFor="fc-explanation">Explanation (optional)</Label>
        <Textarea
          id="fc-explanation"
          value={explanation}
