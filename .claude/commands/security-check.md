...
### 2. Stack-Specific Checks (TypeScript / Next.js (App Router))

**If Next.js (App Router) includes React/Next.js:**
...
**If Next.js (App Router) includes Express/Node.js:**
